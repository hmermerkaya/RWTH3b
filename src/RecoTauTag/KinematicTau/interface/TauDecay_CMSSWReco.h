...
//
// Package:    TauNtuple
// Class:      TauDecay_CMSSWReco
// 
/**\class TauDecay TauDecay_CMSSWReco.cc TauDataFormat/TauNtuple/src/TauDecay_CMSSWReco.cc

 Description: Bridge for TauDecay and reco level objects
...
// $Id: TauDecay_CMSSWReco.h,v 1.2 2011/12/15 15:59:20 inugent Exp $
//
//
#ifndef TauDecay_CMSSWReco_h
#define TauDecay_CMSSWReco_h
...
// class declaration
//
class TauDecay_CMSSWReco : public TauDecay {
public:
  TauDecay_CMSSWReco();
  ~TauDecay_CMSSWReco();
...
private:
  // recursive functions to loop through tau decay products
  void Analyze(const reco::GenParticle *Particle,unsigned int midx);
  void AddFinalStateDecayInfo(const reco::GenParticle *Particle,unsigned int midx);
