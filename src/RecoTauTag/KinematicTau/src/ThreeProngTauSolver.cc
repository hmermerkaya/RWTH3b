...
void ThreeProngTauSolver::quadratic(double &x_plus,double &x_minus,double a, double b, double c){
  double R=b*b-4*a*c;
  if(R<0){R=0;}
...
void ThreeProngTauSolver::AnalyticESolver(TLorentzVector &nu1,TLorentzVector &nu2,TLorentzVector A1){
...
void ThreeProngTauSolver::NumericalESolver(TLorentzVector &nu1,TLorentzVector &nu2,TLorentzVector A1){
  ParticleMassHelper PMH;
...
void ThreeProngTauSolver::SolvebyRotation(TVector3 TauDir,TLorentzVector A1, TLorentzVector &Tau1,TLorentzVector &Tau2,
...
bool ThreeProngTauSolver::SetTauDirectionatThetaGJMax(TLorentzVector a1, double &theta,double &phi){
  ParticleMassHelper PMH;
  double thetaGJMax =asin(( PMH.Get_tauMass()*PMH.Get_tauMass()-a1.M2())/(2.0*PMH.Get_tauMass()*fabs(a1.P())));
